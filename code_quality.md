...
Calculating this type of complexity usually involves a **node-edge** graph called a **flow-graph**. ![Sample flow graph](./images/flow_graph.png){align=center width=500px}.
